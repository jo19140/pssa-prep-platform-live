# Grade 3 PSSA Short Answer Student Preview
...
### pssa_sa_g3_creek_main_idea_01

What is the main idea of the passage? Use two details from the passage to support your answer.

Write a short answer that states the main idea and explains how two passage details support it.
...
### pssa_sa_g3_map_evidence_01

How does the old map help people understand the town's past and present? Use two details from the passage to support your answer.

Write a short answer that explains how information from the map and the passage helps visitors compare the town then and now.
...
### pssa_sa_g3_lunch_sequence_01

Explain how the class solved the lunch-line problem. Use two details from the passage to support your answer.

Write a short answer that explains the problem-solution sequence and supports it with two text details.
...
### pssa_sa_g3_mural_character_01

How does the narrator's attitude about the mural change? Use two details from the passage to support your answer.

Write a short answer that describes the narrator's change and supports it with two passage details.
...
### pssa_sa_g3_cart_connection_01

Why is the order of steps important when fixing the cart? Use two details from the passage to support your answer.

Write a short answer that explains the connection between the steps and the successful repair.
