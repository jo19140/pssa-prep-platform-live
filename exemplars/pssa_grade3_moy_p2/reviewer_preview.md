# MOY P2 Reviewer Preview

Includes keys, rationales, and rubric. All content is PENDING/candidate and noDbWrite.
...
- A: Fresh bread tastes best when it is served at a party. — This focuses on one story detail instead of the larger lesson Nadia learns.
- B: People should avoid asking younger siblings for help. — The passage does not teach that younger siblings should be avoided; Sam is included and may help later.
- C: A person should hurry before a task becomes boring. — This reverses the story's lesson because hurrying causes Nadia's first loaf to fail.
- D (KEY): Patience and trying again can help someone succeed. — Correct. Nadia succeeds after she tries again, waits, and trusts the dough.
...
Key:
{
  "correctCells": [
    {
      "rowId": "row_nadia",
      "columnId": "action_nadia_waits"
    },
    {
      "rowId": "row_sam",
      "columnId": "action_sam_checks"
    },
    {
      "rowId": "row_abuela",
      "columnId": "action_abuela_comforts"
    }
  ]
}
...
Rubric:
- 3: Explains the message and connects at least two accurate passage details, including the rushed first loaf and the successful second loaf or Nadia's changed behavior, to the idea that patience and trying again lead to success.
- 2: Explains the message with one strong detail, or gives two accurate details with a partial connection to the message.
- 1: Names patience, trying again, or a relevant detail but gives little explanation of how the story develops the message.
- 0: Gives an incorrect, unsupported, copied-only, or off-topic response.
