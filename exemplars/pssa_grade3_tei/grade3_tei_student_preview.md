# Grade 3 PSSA Multiple-Select + Hot-Text Student Preview

Review status: PENDING. Item status: candidate. Answers, rationales, scoring, and internal metadata are not shown.
...
Which two details best support the main idea that the class used observations to explain the creek glow?

Choose two answers.

1. Maya drew a map of three creek spots.
2. The teacher brought clear jars and a thermometer.
3. Students compared their notes with the weather chart.
4. A robin hopped in the wet grass on Friday.

### pssa_ht_g3_creek_01

Choose two sentences that best support the main idea that the class used evidence to understand the creek glow.

Choose two sentences.

1. The glow was not bright like a flashlight.
2. Maya drew a map of three creek spots.
3. Those clues helped the class ask a better question: why was the glow strongest in one place?
4. A beetle skated over the surface, and a robin hopped in the wet grass.
...
Which two details show that the old map helped visitors compare the town's past and present?

Choose two answers.

1. A date in the corner said 1928.
2. Mr. Ortiz put a new town map beside the old one.
3. A label told where it was found and how it was opened.
4. Some streets had new names, and the trolley tracks were gone.

### pssa_ht_g3_map_01

Choose two sentences showing that the old map helped people compare past and present.

Choose two sentences.

1. The station manager called Mr. Ortiz, who cared for the town archive.
2. He did not unfold the map quickly.
3. Mr. Ortiz put a new town map beside the old one.
4. Some streets had new names, and the trolley tracks were gone.
...
Which two details show the cause of the lunch-line changes?

Choose two answers.

1. Students picked up milk after they already had full trays.
2. Spoons and napkins were tucked behind the soup pot.
3. The red baskets were easy to spot.
4. Mrs. Lane circled that note in purple marker.

### pssa_ht_g3_lunch_01

Choose two sentences that show what caused the class to change the lunch line.

Choose two sentences.

1. They counted how many times the line paused.
2. First, students picked up milk after they already had full trays, so cartons tipped and rolled.
3. Second, spoons and napkins were tucked behind the soup pot.
4. When the bell rang, most bowls of soup were still warm.
...
Which two details best show the message that mistakes can become part of something good?

Choose two answers.

1. The wall was rough brick, and chalk lines crossed it like a giant puzzle.
2. I wanted to wipe them away, but Grandpa handed me a thin brush.
3. I bent close and painted tiny waves around each tail.
4. The fish seemed to move, and the wall no longer looked empty.

### pssa_ht_g3_mural_01

Choose two sentences that show how the narrator turns a mistake into part of the mural's message.

Choose two sentences.

1. The label said sky blue, but inside the can the paint looked like melted berries.
2. I wanted to wipe them away, but Grandpa handed me a thin brush.
3. I bent close and painted tiny waves around each tail.
...
Which two details explain why the class follows the repair steps in order?

Choose two answers.

1. The green cart in the art room did not.
2. First, you would empty the heavy paper boxes from the bottom shelf.
3. Weight can hide a small problem.
4. After the repair, the cart still squeaked a little.

### pssa_ht_g3_cart_01

Choose two sentences that explain why the cart repair steps should happen in order.

Choose two sentences.

1. A supply cart should roll where you guide it.
2. First, you would empty the heavy paper boxes from the bottom shelf.
3. Weight can hide a small problem.
4. After the repair, the cart still squeaked a little.
