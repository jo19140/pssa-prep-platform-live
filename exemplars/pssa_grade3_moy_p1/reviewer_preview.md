...
Rubric:
- 3: Explains the sequence or cause-effect process and uses at least two accurate passage details, such as arranging exhibits, adding a legend, testing the map, and revising confusing parts.
- 2: Explains the process with one strong passage detail or two details with a partial connection.
- 1: Gives one relevant copied or loosely connected detail but does not explain the process clearly.
- 0: Gives an incorrect, unsupported, or off-topic response.
