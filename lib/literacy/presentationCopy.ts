...
const COACH_THEME: PresentationTheme = {
  ...
  layout: {
    ...
    page: "min-h-screen bg-slate-950 px-3 py-4 text-slate-50 md:px-5",
    grid: "mx-auto grid max-w-7xl gap-4 lg:grid-cols-[104px_minmax(0,1fr)]",
  },
  shell: {
    ...K3_THEME.shell,
    rail: "rounded-[28px] border border-slate-700 bg-slate-900/95 p-3 shadow-xl lg:sticky lg:top-5 lg:h-[calc(100vh-2.5rem)]",
    brandBadge: "grid h-14 w-14 place-items-center rounded-2xl bg-indigo-400 text-xl font-black text-slate-950",
    brandText: "text-xs font-black uppercase tracking-wide text-indigo-100",
    navActive: "border-indigo-300 bg-indigo-950 text-indigo-50",
    navComplete: "border-emerald-400 bg-emerald-950 text-emerald-100",
    navIdle: "border-transparent bg-slate-800 text-slate-300",
    header: "flex flex-col gap-3 rounded-[28px] border border-slate-700 bg-slate-900/95 p-4 shadow-xl md:flex-row md:items-center md:justify-between",
    targetPill: "inline-flex rounded-full border border-indigo-300 bg-indigo-950 px-3 py-1 text-xs font-black text-indigo-100",
    secondaryButton: "rounded-2xl border border-slate-600 bg-slate-800 px-4 py-3 text-sm font-black text-slate-50",
    primaryButton: "rounded-2xl bg-indigo-400 px-4 py-3 text-sm font-black text-slate-950 shadow",
    lessonFrame: "grid min-h-[650px] overflow-hidden rounded-[28px] border border-slate-700 bg-slate-900/95 shadow-xl lg:grid-cols-[260px_minmax(0,1fr)]",
    buddyPanel: "border-b border-slate-700 bg-slate-900 p-5 text-center lg:border-b-0 lg:border-r",
    speechBubble: "rounded-3xl border border-slate-700 bg-slate-800 p-4 text-left text-sm font-extrabold leading-relaxed text-slate-100",
    metaBox: "mt-4 rounded-3xl border border-dashed border-slate-600 bg-slate-800 p-4 text-left text-xs font-black text-slate-300",
    activitySurface: "flex flex-1 flex-col rounded-[26px] border border-slate-700 bg-slate-950 p-5",
    adultPanel: K3_THEME.shell.adultPanel,
  },
  cards: {
    ...K3_THEME.cards,
    blueNotice: "rounded-3xl border-2 border-indigo-700 bg-indigo-950 p-4 text-base font-black leading-relaxed text-indigo-50",
    amberNotice: "rounded-3xl border-2 border-indigo-400 bg-slate-900 p-5 text-xl font-black leading-relaxed text-slate-50",
    demoCard: "rounded-3xl border-2 border-slate-700 bg-slate-900 p-6 text-center",
    generatedCard: "rounded-3xl border-2 border-slate-700 bg-slate-900 p-4",
    neutralCard: "rounded-3xl border border-slate-700 bg-slate-900 p-4",
    dashedCard: "mx-auto max-w-xl rounded-3xl border-2 border-dashed border-slate-600 bg-slate-900 p-6",
    primaryAction: "rounded-2xl bg-indigo-400 px-5 py-4 font-black text-slate-950 disabled:cursor-not-allowed disabled:opacity-50",
    secondaryAction: "rounded-2xl border border-slate-600 bg-slate-800 px-5 py-4 font-black text-slate-50 disabled:cursor-not-allowed disabled:opacity-50",
  },
};
