...
function buildSystemPrompt(input: GenerateLessonV2Input, plannedTeiTypes: string[], leanMode = false) {
  return [
    ...
    [
      ...
      "Every wrong answer choice must be wrong BECAUSE the student does not yet know the target skill, not because of surface features like absence or absurdity.",
      "SPECIFIC RULES BY ITEM TYPE:",
      "1. WORD-FEATURE IDENTIFICATION (phonics patterns, vowel teams, consonant blends, syllable types):",
      "- At least 2 of 3 distractors MUST appear in the target word.",
      "- Distractors that appear in the word must be valid features the student could confuse with the target (e.g., for \"vowel team in rainbow\" with correct answer \"ai\", a good distractor is \"ow\" — also in rainbow, also a vowel team).",
      "- Distractors NOT in the word may only be used if they share a sound or pattern with the correct answer such that the student must know the specific instance to disambiguate.",
      "- FORBIDDEN: distractors that are valid features but obviously not in the word (e.g., \"oa\" or \"ie\" for \"rainbow\").",
      "2. READING COMPREHENSION MC (main idea, inference, text evidence):",
      "- All distractors MUST be derived from the passage. A student should be able to find each distractor's basis somewhere in the text.",
      "- Distractors should be true details from the passage that are NOT the answer to the question (testing relevant vs irrelevant evidence).",
      "- FORBIDDEN: distractors that contradict the passage outright, or claims about topics not mentioned at all.",
      "3. VOCABULARY IN CONTEXT:",
      "- Distractors must share the part of speech of the correct answer.",
      "- Distractors should be plausible substitutes that fail in this specific context (near-synonyms, words from same word family, words with similar sound).",
      "- FORBIDDEN: distractors that don't fit the sentence's syntactic slot.",
      "4. CONVENTIONS (subject-verb agreement, verb tense, punctuation):",
      "- Distractors must be plausible grammar errors a student making a specific mistake might pick.",
      "- For verb tense: distractors should be other tenses that share part of speech.",
      "- For subject-verb: distractors should be verbs that agree in some respect but fail another rule.",
      "- FORBIDDEN: distractors that aren't grammatical structures at all, or that mismatch the basic part of speech of the correct answer.",
      "5. THEME / CHARACTER ANALYSIS:",
      "- Distractors must reference characters or events from the passage.",
      "- Distractors should be plausible misreadings by a student who only got surface impressions.",
      "- FORBIDDEN: themes from texts not given, character traits never demonstrated.",
      "VERIFICATION CHECK FOR EVERY MC ITEM:",
      "For each distractor, ask: \"If a student picks this, what specific misunderstanding does it reveal?\" If the answer is \"they don't know the word/passage exists\" or \"they didn't read at all,\" the distractor is bad. Replace it.",
    ].join("\n"),
