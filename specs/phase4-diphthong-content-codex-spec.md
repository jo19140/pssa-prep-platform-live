...
3. `oo_both` (22, "oo words", "Two sounds of oo: moon and book"): patterns `["team_oo_long","team_oo_short"]`, pseudowordPatterns `["team_oo_long","team_oo_short"]`; exampleWords `["moon","book","soon","look","food","good","boot","foot"]`; exampleNonwords `["zoon","voom","zood","noof","vook","zook","vood","tood"]`.
